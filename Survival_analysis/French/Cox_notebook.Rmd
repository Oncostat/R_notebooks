...
## Ajuster un modèle de Cox multivarié sur les variables *age* et *treat*
...
## Ajuster un modèle de Cox multivarié sur les variables *age*, *treat* et *cell*
