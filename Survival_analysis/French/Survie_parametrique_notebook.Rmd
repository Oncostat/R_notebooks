...
scale_logNorm2<-exp(fit_logNorm2$scale)
```
...
print(paste0("Prédiction pour les hommes : ",predict(fit_weib2,newdata = list(sex=1))))
#prediction pour sex = 2
print(paste0("Prédiction pour les femmes : ",predict(fit_weib2,newdata = list(sex=2))))
